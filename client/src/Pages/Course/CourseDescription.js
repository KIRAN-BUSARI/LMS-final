        ...
        <div className="grid grid-cols-2 gap-10 py-10 relative">
          ...
          <div className="space-y-5">
            ...
            <div className="space-y-4">
              ...
              {/* Combined conditional rendering for buttons */}
              <div className="block">
                {role === "ADMIN" && (
                  <>
                    <button
                      onClick={() => navigate("/course/displaylectures", { state: { ...state } })}
                      className="bg-yellow-600 text-xl rounded-md font-bold px-4 py-2 w-[45%] mr-1 hover:bg-yellow-500 transition-all ease-in-out duration-300"
                    >
                      Watch Lectures
                    </button>
                    <button
                  ...
                  <>
                    {data?.subscription?.status === "active" ? (
                      ...
                      <button
                        ...
                        className="bg-yellow-600 text-xl rounded-md font-bold px-4 py-2 w-full mr-1 hover:bg-yellow-500 transition-all ease-in-out duration-300"
                      >
                        Subscribe to Course
                      </button>
                    )}
